...
public class MainActivity extends AppCompatActivity {
                ...
                synchronized (this) {
                    ...
                    if (intent.getBooleanExtra(
                        ...
                        if (device != null) {
                            ...
                            logMsg("Permission denied: device is null.");
                        }
        ...
        protected void onProgressUpdate(TransmitProgress... progress) {
            ...
            if (progress[0].e != null) {
                ...
                if (progress[0].response != null
                    ...
                    // Show control codes for IOTL_GET_FEATURE_REQUEST
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onStateChange(int slotNum, int prevState, int currState) {
                ...
                if (currState == Reader.CARD_PRESENT) {
                    ...
                    try {
                        ...
                        // Try to convert UID to a Long after loop
                        try {
                            Long result = Long.parseLong(uid.toString(), 16);
                            runOnUiThread(() -> logMsg("Data ---> " + result));
                        } catch (NumberFormatException e) {
                            runOnUiThread(() -> logMsg("Data ---> Error: Unable to parse UID as a number"));
                        }
        ...
        mPermissionIntent = PendingIntent.getBroadcast(this, 0, new Intent(
                ACTION_USB_PERMISSION),  android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S ? PendingIntent.FLAG_MUTABLE : 0);
